/**
 Date: 09-28-2021
 Description:
 my idea of fixing the "all hair in 1 place also it keeps jiggling" problem:
   - find a way to capture the z values of terrain on startup, & hand it over to
     hairArray outside of draw
   - generate hair coords once it's been declared, not during drawing
   - i was gonna say something here but i forgot
   - make a move function within hair object
 Reference:
